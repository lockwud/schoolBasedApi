...
-- AlterTable
ALTER TABLE "paymentRequest" ALTER COLUMN "studentId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "solveAssignment" ALTER COLUMN "studentId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "student" ALTER COLUMN "studentId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "studentTerminalReport" ALTER COLUMN "studentId" SET DATA TYPE TEXT;
