...
exports.deleteTutorRecords = exports.otpVerification = exports.deleteTutor = exports.updateTutorDetails = exports.getTutorByEmail = exports.getTtutorById = exports.getTutors = exports.login = exports.signUp = void 0;
const tutorService = __importStar(require("../services/tutor.service"));
...
exports.login = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(http_status_1.HttpStatus.OK).json({ message: tutorLogin });
}));
