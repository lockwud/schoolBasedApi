...
exports.tutorsSubject = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(http_status_1.HttpStatus.ACCEPTED).json({ message: `Mr. ${assignedTutor.surname}has been assigned to teach ${subject}` });
}));
...
exports.updateTutorSubject = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(http_status_1.HttpStatus.OK).json({ message: `Mr. ${updated.surname}, has been assigned to teach ${subjectName}` });
}));
