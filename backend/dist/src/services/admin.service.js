...
exports.resetPassword = exports.verifyOtp = exports.forgotPassword = exports.deleteAdminRecords = exports.fetchAdminById = exports.fetchAllAdmins = exports.fetchAdminByEmail = exports.updateAdmin = exports.signInAdmin = exports.registerAdmin = void 0;
...
const registerAdmin = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!checkAdminAvailability) {
        ...
        const registrationCode = yield (0, referralCodeGenerator_1.generateReferallCode)();
        // Save admin to the database
        const saveAdmin = yield prisma_1.default.admin.create({
            data: Object.assign(Object.assign({}, data), { tutorRegistrationCode: registrationCode, password: HashedAdminPassword }),
        });
...
const signInAdmin = (email, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verifyPassword = yield (0, bcrypt_1.compare)(password, findAdmin === null || findAdmin === void 0 ? void 0 : findAdmin.password);
    if (!verifyPassword) {
...
const verifyOtp = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findAdmin) {
        ...
        if (findAdmin.otp === otp) {
            const token = (0, jsonwebtoken_1.signToken)({ id: findAdmin.id, role: "admin" });
            yield prisma_1.default.admin.update({
                where: {
                    email
                },
...
const resetPassword = (newPassword, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const admin = yield prisma_1.default.admin.findFirst({ where: { token } });
    if (!admin) {
        (0, errorHandler_1.throwError)(http_status_1.HttpStatus.UNAUTHORIZED, "Invalid or expired token");
    }
    const hashedPassword = yield (0, bcrypt_1.hash)(newPassword);
    yield prisma_1.default.admin.update({
        where: { id: admin === null || admin === void 0 ? void 0 : admin.id },
        data: {
