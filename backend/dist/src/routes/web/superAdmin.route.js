...
const superAdmin = __importStar(require("../../controllers/superAdmin.controller"));
const superAdminRoute = (0, express_1.Router)();
superAdminRoute.post("/signin", (0, validate_payload_1.validatePayload)('superAdmin'), superAdmin.signIn);
