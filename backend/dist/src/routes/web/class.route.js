...
const classes = __importStar(require("../../controllers/class.controller"));
...
classes.getClasses);
const getClassByIdLimiter = (0, express_rate_limit_1.default)({
    windowMs: 15 * 60 * 1000, // 15 minutes
    max: 100, // limit each IP to 100 requests per windowMs
});
classRoute.get("/:id", getClassByIdLimiter, jsonwebtoken_1.authenticateJWT, (0, jsonwebtoken_1.authorizeRole)(["admin", "tutors"]), classes.getClassById);
